...
\input{filter_transfer/fig_low_pass}
...
\begin{enumerate}
  ...
  \item The circuit can be simplified as:
    ...
    \input{filter_transfer/fig_simplified_low_pass}
...
\input{filter_transfer/fig_high_pass}
...
\begin{enumerate}
  ...
  \item The circuit can be simplified as:
    ...
    \input{filter_transfer/fig_simplified_high_pass}
...
\input{filter_transfer/fig_band_pass}
...
\begin{enumerate}
  ...
  \item The circuit can be simplified as:
     ...
     \input{filter_transfer/fig_simplified_band_pass}
