...
\begin{enumerate}
    \qitem What is the controllability matrix, $\mathcal{C}$, for this system? What is its column space and rank? Is the system controllable?
    ...
    \sol{
        ...
        Therefore the controllability matrix has rank 2 and system is not controllable.
...
\begin{enumerate}[resume]
  ...
  \sol {
    ...
    Therefore the controllabilty matrix has rank 3, and the system is controllable.
  }

  \qitem Starting at $\vec{x}(0) = \begin{bmatrix} 1 \\ 0 \\ 0 \end{bmatrix}$, what possible states can we reach after one timestep? \vskip 1.1pt 
  How about in two timesteps? Three?
  ...
  \sol {
    It will take three time steps to reach this state. 
    We unfortunately cannot reach this vector in fewer than three timesteps because $\begin{bmatrix} 1 \\ 0 \\ 2 \end{bmatrix}$ is not in the form $\begin{bmatrix} c_1 \\ 0 \\ -1 \end{bmatrix}$ or $\begin{bmatrix} c_1 \\ 2 \\ c_2 \end{bmatrix}.$
  }

  \qitem What is the minimum number of timesteps it takes to reach $\begin{bmatrix} 1 \\ 2 \\ 3 \end{bmatrix}$?
