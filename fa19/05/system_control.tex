...
\qitem Given $n$ observations, where in our state space can $\vec{x}$ reach at time $t = n?$
...
\end{equation}
Based on the previous parts, when can we say our system is "controllable?" (i.e. we can reach anywhere in our state space using our system)
