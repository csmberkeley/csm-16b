...
\begin{enumerate}
\qitem To solve this, we want to come up with a change of variables such that $\frac{d}{dt} \widetilde{x}(t) = \alpha \widetilde{x}(t)$. Write out $\widetilde{x}(t)$ in terms of $x(t)$. \\
\sol {
