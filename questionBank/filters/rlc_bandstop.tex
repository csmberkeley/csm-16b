...
\qitem
Write out the transfer function of figure 1.

\meta{
See if you can get students to guess what the behavior will ultimately be.
}
...
While the bandpass filter allows a range of frequencies through, the bandstop/notch stops a particular frequency from passing through.
