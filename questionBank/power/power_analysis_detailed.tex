...
\begin{enumerate}
    \qitem First we need to transform the whole circuit from time domain to pahsor domain. Please \textbf{redraw the circuit} with only
    ...
    \sol{
        ...
        \begin{align*}
            ...
            &= \frac{1000\sqrt{2}e^{\frac{\pi}{2}j}}{1000e^{\frac{\pi}{4}j}} \\
            &= \sqrt{2}e^{\frac{\pi}{4}j}.
        \end{align*}
        }
    ...
    \sol{
        The real power is
        \begin{equation*}
            P = \frac{1}{2} |\widetilde{V}| |\widetilde{I}| \cos(\angle(Z_{tot})) = \SI{1}{\kilo\watt}
        \end{equation*}
        The reactive power is
        \begin{equation*}
            Q = \frac{1}{2} |\widetilde{V}| |\widetilde{I}| \sin(\angle(Z_{tot})) = \SI{1.414}{\kilo\var}
        \end{equation*}
    ...
    \sol{
        ...
        From the phasor representation to the time domain, we know that $i(t)=\sqrt{2}cos(1000t+\frac{\pi}{4})$.
