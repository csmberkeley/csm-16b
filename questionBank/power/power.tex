...
\qitem \textbf{Can you find $P(t)$ and try to simplify it into the form on which we can perform integral.}?  \textit{Hint:} Use the Euler's Form to make the calculation easier.
...
\qitem \textbf{By using integral, prove that} $P_{avg}=\frac{V_mI_m}{2}cos({\theta}_1-{\theta}_2)$.
...
Also we introduce three concepts related to the power factor: Reactive Power, True Power, and Apparent Power, and here are several properties of the power factor you should know:
\newline 1. $\text{power factor}=\frac{\text{true power}}{\text{apparent power}}=cos({\theta}_d)$
\newline 2. $\text{apparent power}^2=\text{true power}^2+\text{reactive power}^2$
