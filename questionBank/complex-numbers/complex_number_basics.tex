...
\sol{
$z = a + bj$. We can go from rectangular form to polar form by using the equation $z = |z|e^{j\theta}$, where $|z| = \sqrt{a^2 + b^2}$ and $\theta = \angle z = tan^{-1}(\frac{b}{a})$. So, \\
$$ z = 10 + 12j $$
$$ |z| = \sqrt{10^2 + 12^2} = \sqrt{244}$$
$$ \angle z = tan^{-1}(\frac{12}{10})$$
$$ z = \sqrt{244}e^{j{tan^{-1}(\frac{12}{10})}} \approx 15.620e^{0.876j}$$
}
\end{enumerate}
...
$$ a = 22cos(23) $$
$$ b = 22sin(23) $$
$$ z = 22cos(23) + 22j sin(23) \approx -11.722 + -18.617j$$
...
$|z| = \sqrt{0^2 + (-1)^2} = 1.$ \\
$\angle z = \angle -j = \frac{3\pi}{2} $ rad.
}
\\
...
$\angle z = \angle \frac{3}{5}j = \frac{\pi}{2}$ rad.
}
\\
...
$\angle z = \angle z_a - \angle z_b = tan^{-1}(\frac{2}{1}) - tan^{-1}(\frac{7}{9}) = 1.107 + 0.661 \approx 1.768$ rad.
}
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{enumerate}
