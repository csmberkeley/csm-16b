...
\qitem For $v(t) = V_{0} \cos(\omega{}t + \phi{})$, write an expression for $i(t)$ in the form $i(t) = A\widetilde{V}e^{j\omega{}t} + B\overline{\widetilde{V}}e^{j\omega{}t}$ for $A, B \in{} \mathbb{C}$.\\ 
Hint: Remember that $e^{j\frac{\pi{}}{2}} = j$.
...
Write an expression for $v(t)$, similar to the previous part but in the form $v(t) = A\widetilde{I}e^{j\omega{}t} + B\overline{\widetilde{I}}e^{j\omega{}t}$. \\
Hint: The identity $-\sin (x) = cos(x + \frac{\pi}{2})$ may be helpful.
