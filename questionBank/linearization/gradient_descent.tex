...
\sol{
The biggest disadvantage of gradient descent is that it may end up finding a local minimum instead of a global minimum.
Additionally, this algorithm is only approximate, so it's possible you may not even hit the local minimum properly.
Though, by tuning the hyperparameter $\alpha$, you should get arbitrarily close.
