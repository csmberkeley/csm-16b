...
\begin{enumerate}
	...
	\qsolans{ By the nice property of the basis, we have
	\begin{align*}
 ...
 then the property required in part (b) is satisfied. What is the intuition behind this construction?
  ...
  \qsolans{Because we have $b_i = y_i$ and the basis defined in last part, we can write out
	\begin{align*}
	h(x) &= b_0L_0(x) + b_1L_1(x) + b_2L_2(x) +\cdots + b_{n-1}L_{n-1}(x)\\
   ...
   \qsolans{Direct calculation yields
