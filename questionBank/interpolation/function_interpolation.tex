...
\begin{enumerate}
	...
	\begin{align*}
	\phi(x) = \begin{cases}
	                1-\frac{\mid x \mid}{\frac{\pi}{2}} & |x| \leq \delta \\
	      			0 & \text{else} \\
	   		    \end{cases}
	\end{align*}
	...
	\begin{align*}
	\phi (x) = \begin{cases}
	                1-\frac{\mid x-\frac{\pi}{4} \mid}{\frac{\pi}{2}} & |x -\frac{\pi}{4}|\leq\delta \\
	      			0 & \text{else} \\
	   		    \end{cases}
	\end{align*}
	\begin{equation*}
	\phi(x) = \begin{cases}
	                1-\frac{\mid x-\frac{3\pi}{4} \mid}{\frac{\pi}2} & |x-\frac{3\pi}{4}|\leq\delta \\
	      			0 & \text{else} \\
	   		    \end{cases}
	\end{equation*}
	\begin{equation*}
	\phi(x) = \begin{cases}
	                1-\frac{\mid x- \frac{5\pi}{4} \mid}{\frac{\pi}2} & |x- \frac{5\pi}{4}|\leq\delta \\
	      			0 & \text{else} \\
	   		    \end{cases}
	\end{equation*}
	\begin{equation*}
