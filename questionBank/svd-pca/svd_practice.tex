...
\begin{enumerate}[label=(\roman*)]
  ...
  \meta{
  For this problem, we don't really need gram schmidt.
  That's because we only have one vector in the nullspace.
  If we had more vectors in the nullspace, then we'd need gram schmidt.
  }
