...
\qitem How do I make it so that the DFT matrix we defined becomes an orthogonal matrix?
{\em HINT: An orthogonal matrix is a matrix that when multiplied with itself gives us the identity}
