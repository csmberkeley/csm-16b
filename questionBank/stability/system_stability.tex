...
\begin{enumerate}
  ...
  \qitem Under what conditions will $\ddt{}{t} z_{n}(t) = \lambda_{n} z_{n}(t) + \widetilde{u}_{n}(t)$ be stable?
  ...
  \qitem Using back-substitution, confirm that $\ddt{}{t} \vec{z}(t) = R \vec{z}(t) + \vec{\widetilde{u}}(t)$ will be stable when $\mathfrak{Re}(\lambda_i) < 0$ for all $i.$
  ...
  \meta {
    ...
    Therefore, we say the system is guaranteed to be BIBO stable when $\mathfrak{Re}(\lambda_i) < 0.$ 
