...
\textbf{Learning Goal: }
\begin{bindenum}
    \item Teach students how to a summer circuit can be used to average multiple voltage sources
    \item Teach students the common method of cascading multiple circuits, each responsible for different functions.
\end{bindenum}
...
\begin{enumerate}
    ...
    \item {
        Now, draw a circuit the left box that can be used to invert the sign of our signal. Suppose you have access to one op amp and one resistor, which can have any value. Specify the value of your chosen resistor
