...
For an LRC bandpass filter with $\omega_n = 10^4$, the magnitude of the transfer function would look something like this (\textit{Note: the transfer function is on a log-log scale})
\begin{tikzpicture}[
    declare function={
