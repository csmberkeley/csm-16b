...
% DONE Frequency Domain
% DONE Phasors (e^{j \phi}, intuition: cos(\omega t + \phi) is the real part of e^{j(\omega t + \phi)}, get rid of the \omega t part because the circuit cannot introduce new frequencies)
% DONE Impedance of common circuit elements(R, L, C)
