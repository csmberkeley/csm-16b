...
\qitem \textbf{Try writing the original equation as a differential equation in terms of $\widetilde{x}(t)$.} \\
...
\qitem \textbf{What is the final solution $x(t)$?} Assume that $x(0)$ is given.
