...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance = 2cm, thick,every node/.style={inner sep=0.25em,outer sep=0.25em}]%
    ...
    \draw[->] (1.45) -- node [rectangle,draw,midway,above,minimum size=1.5em] {} (2.135);
    \draw[->] (2.225) -- node [rectangle,draw,midway,below,minimum size=1.5em] {} (1.315);
  \end{tikzpicture}%
\end{figure}
...
(Hint: Start by writing $\widetilde{\vec{x}}$ and $\widetilde{\vec{y}}$ in terms of $\vec{x}, \vec{y}$. Refer to the state diagram from before.)
\vspace{3em}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[node distance = 2cm, thick, every node/.style={inner sep=0.25em,outer sep=0.25em}]%
    ...
    \draw[->] (1) -- node [rectangle,draw,midway,above,minimum size=1.5em] {} (2);
    \draw[->] (1.240) -- node [rectangle,draw,midway,left,minimum size=1.5em]{} (4.120);
    \draw[->] (4.60) -- node [rectangle,draw,midway,right,minimum size=1.5em]{} (1.300);
    \draw[->] (2.300) -- node [rectangle,draw,midway,right,minimum size=1.5em]{} (3.60);
    \draw[->] (3.120) -- node [rectangle,draw,midway,left,minimum size=1.5em]{} (2.240);
    \draw[->] (4) -- node [rectangle,draw,midway,below,minimum size=1.5em] {} (3);
  \end{tikzpicture}%
\end{figure}
